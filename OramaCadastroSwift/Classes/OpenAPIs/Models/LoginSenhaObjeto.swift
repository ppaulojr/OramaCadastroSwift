...
@objc public class LoginSenhaObjeto: NSObject, Codable { 
    ...
    public init(nome: String, celular: String, cpf: String, email: String, dataNascimento: Date, senha: String) {
        self.nome = nome
